...
<template>
  <div @mousedown="getBlur" ref="containerRef" class="container-w">
    <div ref="dragElement" class="drag-bar">
      <!-- 图标 -->
      <div class="w-out" @click="out"><svg t="1668154156579" class="icon" viewBox="0 0 1024 1024" version="1.1"
          xmlns="http://www.w3.org/2000/svg" p-id="14016" width="8" height="8">
          <path
      ...
      <div class="w-narrow" @click="narrow"><svg t="1668154811434" class="icon" viewBox="0 0 1024 1024" version="1.1"
          xmlns="http://www.w3.org/2000/svg" p-id="16430" width="8" height="8">
          <path
