...
<template>
  <div @mousedown="getBlur" ref="containerRef" class="container-w">
    <div ref="dragElement" class="drag-bar">
      ...
      <div class="w-narrow" @mousedown.stop="" @click="narrow"><svg t="1668154811434" class="icon" viewBox="0 0 1024 1024"
          version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="16430" width="8" height="8">
          <path
